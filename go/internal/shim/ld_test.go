...
// parseLDArgs must recognise the `-r` partial-link shape and nothing
// else. Full links belong to Link, which sees the compiler driver's
// command line rather than ld's.
